...
.. glossary::
   ...
   VMC Script
       Python script, generated by :term:`pyarmor`, some Python statements are converted to Pyarmor VM code.

       It need import Python extension :term:`pyarmor_mini` to run

   ECC Script
       Python script, generated by :term:`pyarmor`, some Python statements are converted to real machine code.
